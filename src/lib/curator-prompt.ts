...
export function buildBrief(input: RecommendRequest) {
  ...
  return [
    ...
    ``,
    `SKIN SCAN (measured in store, ${defaultProfile.scan.date} at ${defaultProfile.scan.store}) — supporting evidence only`,
...
- Her declared Beauty Profile concerns outrank the Skin Scan whenever they conflict. Use scan metrics as supporting evidence and cite a number when it strengthens a reason (e.g. "your scan puts hydration at 64").
